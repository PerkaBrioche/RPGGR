...
struct CharacterStats LaunchStats()
{
    ...
    CreateRect(AddLife, 70, 50 , sf::Color::Blue, sf::Color::White, 2.0f, { 150.0f, 275 });
    CreateRect(AddStrengh, 70, 50, sf::Color::Green, sf::Color::White, 2.0f, {300, 275 });
    CreateRect(AddDefense, 70, 50, sf::Color::Green, sf::Color::White, 2.0f, {450, 275 });
    CreateRect(AddCriticals, 70, 50, sf::Color::Green, sf::Color::White, 2.0f, {600, 275 });
